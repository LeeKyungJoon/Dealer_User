...
export default function EnterSellsPrice({ route, navigation }) {
  const { all, count } = route.params;
  const [price, setPrice] = useState('');

  const _price = (pricetext) => {
    setPrice(pricetext);
  };
        ...
        >
          <View>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate('DefaultInfo', {
                    all: all,
                    count: count + 1,
                  });
                }}
                ...
                style={{
                  ...
                  backgroundColor:
                    price.length > 0 ? '#459bfe' : 'rgba(69, 155, 254, 0.3)',
                }}
              >
